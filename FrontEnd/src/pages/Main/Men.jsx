...
//             {/* Product Grid */}
//             <div className="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 sm:gap-6 md:gap-8 justify-center items-center">
//               {categoryProducts.map((p) => (
//                 <ProductCard key={p._id} product={p} />
//               ))}
//             </div>
      ...
      {categories.map((cat) => {
        ...
        return (
          <div key={cat} className="mb-10 sm:mb-12 md:mb-16">
            ...
            {/* Product Grid */}
            <div className="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 sm:gap-6 md:gap-8 justify-items-center">
              {categoryProducts.map((p) => (
                <ProductCard key={p._id} product={p} />
              ))}
            </div>
